...
export function HomePage({ onLogout, onNavigateToProfile, onNavigateToCreateQuiz, onNavigateToFeatures }: HomePageProps) {
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16 relative">
          ...
          >
            ...
            <h1 className="text-[#003B73] mb-4 text-5xl md:text-6xl lg:text-7xl">
