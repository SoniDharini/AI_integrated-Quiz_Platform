...
export function CreateQuizPage({ onBack }: CreateQuizPageProps) {
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-[#DFF4FF] rounded-lg appearance-none cursor-pointer accent-[#003B73]"
                  />
                  <div className="flex justify-between text-[#003B73]/60 mt-1">
                    <span>5</span>
                    <span>30</span>
                  </div>
                </div>
                ...
                <div className="pt-4">
                  <button
                    onClick={handleContinue}
                    className="w-full py-4 bg-gradient-to-r from-[#003B73] to-[#0056A8] text-white rounded-2xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                  >
        ...
        {step === 'complete' && (
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-[#003B73]/10 p-12 text-center">
              ...
              <p className="text-[#003B73]/70 mb-8">
                Your AI-powered quiz is ready. {numQuestions} multiple choice questions have been generated based on your material.
              </p>
              ...
              <div className="bg-gradient-to-r from-[#DFF4FF]/30 to-white rounded-2xl p-6 mb-8 text-left max-w-md mx-auto">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#003B73]">{quizTitle || 'Untitled Quiz'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[#003B73]/70">Questions:</span>
                    <span className="text-[#003B73]">{numQuestions}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[#003B73]/70">Difficulty:</span>
                    <span className="text-[#003B73] capitalize">{difficulty}</span>
                  </div>
                  <div className="flex justify-between">
